...
<button onClick={()=>navigate('/re')} style={{display:"block",width:"100%",padding:"10px",fontSize:13,borderRadius:"var(--border-radius-md)",border:"0.5px solid #534AB7",background:"#EEEDFE",color:"#26215C",cursor:"pointer",textAlign:"center",marginTop:8}}>✝️ RE Revision — The big questions</button>
<button onClick={()=>navigate('/exam')} style={{display:"block",width:"100%",padding:"10px",fontSize:13,borderRadius:"var(--border-radius-md)",border:"0.5px solid #1D9E75",background:"#E1F5EE",color:"#085041",cursor:"pointer",textAlign:"center",marginTop:8}}>📝 Mini Exam Mode — test yourself</button>
   {newBadges.length>0&&<div style={{marginTop:"1rem",padding:"12px",borderRadius:"var(--border-radius-md)",background:"#E1F5EE",border:"0.5px solid #1D9E75"}}>
